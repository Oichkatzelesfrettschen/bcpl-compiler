...
static void bcpl_call(bcpl_word_t addr) {
    // Simplified function call mechanism
    // In a complete implementation, this would handle function dispatch
    // For now, we just note the call
    printf("// Function call to address %d\n", addr);
}
...
static void bcpl_start(void) {
    ...
    // Forward declaration: L94
    // Forward declaration: L115
    // Forward declaration: L2
    // Forward declaration: L17
    // Forward declaration: L18
    // Forward declaration: L79
    // Forward declaration: L108
    // Forward declaration: L89
    // Forward declaration: L23
    // Forward declaration: L96
    // Forward declaration: L10
    // Forward declaration: L121
    // Forward declaration: L78
    // Forward declaration: L137
    // Forward declaration: L135
    // Forward declaration: L21
    // Forward declaration: L32
    // Forward declaration: L36
    // Forward declaration: L58
    // Forward declaration: L104
    // Forward declaration: L6
    // Forward declaration: L88
    // Forward declaration: L65
    // Forward declaration: L16
    // Forward declaration: L86
    // Forward declaration: L93
    // Forward declaration: L134
    // Forward declaration: L59
    // Forward declaration: L105
    // Forward declaration: L81
    // Forward declaration: L63
    // Forward declaration: L67
    // Forward declaration: L34
    // Forward declaration: L90
    // Forward declaration: L49
    // Forward declaration: L75
    // Forward declaration: L40
    // Forward declaration: L132
    // Forward declaration: L128
    // Forward declaration: L48
    // Forward declaration: L38
    // Forward declaration: L28
    // Forward declaration: L46
    // Forward declaration: L116
    // Forward declaration: L71
    // Forward declaration: L64
    // Forward declaration: L130
    // Forward declaration: L14
    // Forward declaration: L117
    // Forward declaration: L124
    // Forward declaration: L8
    // Forward declaration: L52
    // Forward declaration: L66
    // Forward declaration: L44
    // Forward declaration: L111
    // Forward declaration: L70
    // Forward declaration: L120
    // Forward declaration: L41
    // Forward declaration: L99
    // Forward declaration: L125
    // Forward declaration: L1
    // Forward declaration: L101
    // Forward declaration: L27
    // Forward declaration: L103
    // Forward declaration: L106
    // Forward declaration: L31
    // Forward declaration: L43
    // Forward declaration: L50
    // Forward declaration: L91
    // Forward declaration: L77
    // Forward declaration: L42
    // Forward declaration: L61
    // Forward declaration: L3
    // Forward declaration: L85
    // Forward declaration: L19
    // Forward declaration: L62
    // Forward declaration: L51
    // Forward declaration: L74
    // Forward declaration: L45
    // Forward declaration: L98
    // Forward declaration: L84
    // Forward declaration: L92
    // Forward declaration: L102
    // Forward declaration: L107
    // Forward declaration: L60
    // Forward declaration: L126
    // Forward declaration: L69
    // Forward declaration: L123
    // Forward declaration: L110
    // Forward declaration: L95
    // Forward declaration: L39
    // Forward declaration: L20
    // Forward declaration: L55
    // Forward declaration: L33
    // Forward declaration: L72
    // Forward declaration: L24
    // Forward declaration: L73
    // Forward declaration: L5
    // Forward declaration: L15
    // Forward declaration: L37
    // Forward declaration: L25
    // Forward declaration: L109
    // Forward declaration: L119
    // Forward declaration: L127
    // Forward declaration: L129
    // Forward declaration: L133
    // Forward declaration: L82
    // Forward declaration: L9
    // Forward declaration: L131
    // Forward declaration: L4
    // Forward declaration: L80
    // Forward declaration: L83
    // Forward declaration: L87
    // Forward declaration: L26
    // Forward declaration: L53
    // Forward declaration: L54
    // Forward declaration: L57
    // Forward declaration: L7
    // Forward declaration: L68
    // Forward declaration: L112
    // Forward declaration: L122
    // Forward declaration: L113
    // Forward declaration: L136
    // Forward declaration: L12
    // Forward declaration: L114
    // Forward declaration: L22
    // Forward declaration: L118
    // Forward declaration: L11
    // Forward declaration: L35
    // Forward declaration: L29
    // Forward declaration: L76
    // Forward declaration: L97
    // Forward declaration: L47
    // Forward declaration: L100
    // Forward declaration: L13
    // Forward declaration: L56
    // Forward declaration: L30
    ...
    // STRING_CONSTANT definition
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 49; } // BRANCH_IF_EQ
    bcpl_push(bcpl_globals[2]); // LOAD_GLOBAL
    bcpl_call(L2); // CALL_FUNCTION
    // FUNCTION_START 8
    L1:
    // UNKNOWN_78 78 - not implemented
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 84; } // BRANCH_IF_EQ
    // UNKNOWN_83 83 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 77; } // BRANCH_IF_LT
    // UNKNOWN_66 66 - not implemented
    // FUNCTION_END 2
    bcpl_push(bcpl_rdch()); // READ_CHAR
    ...
    // STRING_CONSTANT definition
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 50; } // BRANCH_IF_EQ
    bcpl_push(bcpl_globals[2]); // LOAD_GLOBAL
    // LOOP_START L4
    // LOOP_END L3
    bcpl_call(L5); // CALL_FUNCTION
    ...
    // PUSH_STRING - string handling
    // UNKNOWN_75 75 - not implemented
    bcpl_call(80); // CALL_FUNCTION
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 79; } // BRANCH_IF_NEQ
    // UNKNOWN_82 82 - not implemented
    bcpl_pop(); // POP
    // FUNCTION_END 2
    bcpl_push(bcpl_load_indirect(0)); // LOAD_INDIRECT
    ...
    // STRING_CONSTANT definition
    // UNKNOWN_83 83 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 83; } // BRANCH_IF_LT
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 79; } // BRANCH_IF_NEQ
    // UNKNOWN_82 82 - not implemented
    bcpl_pop(); // POP
    // UNKNOWN_83 83 - not implemented
    ...
    // UNKNOWN_102 102 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 102; } // BRANCH_IF_LT
    // UNKNOWN_66 66 - not implemented
    // UNKNOWN_102 102 - not implemented
    // LOOP_START 102
    // UNKNOWN_71 71 - not implemented
    ...
    // UNKNOWN_47 47 - not implemented
    // UNKNOWN_66 66 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 47; } // BRANCH_IF_LT
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_65 65 - not implemented
    // UNKNOWN_83 83 - not implemented
    // LOCAL_VAR allocation
    ...
    // UNKNOWN_47 47 - not implemented
    // STRING_CONSTANT definition
    if (bcpl_pop()) goto 47; // CONDITIONAL_JUMP
    // STRING_CONSTANT definition
    // LOCAL_VAR allocation
    // UNKNOWN_47 47 - not implemented
    // STRING_CONSTANT definition
    ...
    // UNKNOWN_65 65 - not implemented
    // UNKNOWN_84 84 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 72; } // BRANCH_IF_NEQ
    // UNKNOWN_73 73 - not implemented
    // STRING_CONSTANT definition
    // LOCAL_VAR allocation
    // UNKNOWN_47 47 - not implemented
    ...
    // UNKNOWN_65 65 - not implemented
    // UNKNOWN_84 84 - not implemented
    bcpl_call(78); // CALL_FUNCTION
    // UNKNOWN_84 84 - not implemented
    // UNKNOWN_73 73 - not implemented
    // STRING_CONSTANT definition
    // UNKNOWN_47 47 - not implemented
    // UNKNOWN_83 83 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 73; } // BRANCH_IF_NEQ
    // UNKNOWN_84 84 - not implemented
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_72 72 - not implemented
    // PUSH_STRING - string handling
    ...
    // UNKNOWN_83 83 - not implemented
    // UNKNOWN_47 47 - not implemented
    if (bcpl_pop()) goto 69; // CONDITIONAL_JUMP
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_47 47 - not implemented
    if (bcpl_pop()) goto 65; // CONDITIONAL_JUMP
    // STRING_CONSTANT definition
    // PUSH_STRING - string handling
    // TEMP_VAR allocation
    // UNKNOWN_47 47 - not implemented
    ...
    // STRING_CONSTANT definition
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 51; } // BRANCH_IF_EQ
    bcpl_push(bcpl_globals[2]); // LOAD_GLOBAL
    // LOOP_START L8
    // LOOP_END L7
    // LOOP_START L11
    // LOOP_END L10
    bcpl_call(L12); // CALL_FUNCTION
    // FUNCTION_START 3
    L1:
    // UNKNOWN_82 82 - not implemented
    // UNKNOWN_67 67 - not implemented
    ...
    // FUNCTION_START 7
    L2:
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 82; } // BRANCH_IF_NEQ
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_72 72 - not implemented
    // UNKNOWN_66 66 - not implemented
    bcpl_call(70); // CALL_FUNCTION
    // FUNCTION_END 2
    bcpl_push(bcpl_globals[4]); // LOAD_GLOBAL
    goto L4; // JUMP
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); bcpl_push(a * b); } // MULTIPLY
    ...
    // UNKNOWN_72 72 - not implemented
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 95; } // BRANCH_IF_EQ
    bcpl_writes(bcpl_pop()); // WRITE_STRING
    bcpl_push(bcpl_load_indirect(0)); // LOAD_INDIRECT
    { bcpl_word_t addr = bcpl_pop(); bcpl_word_t val = bcpl_pop(); bcpl_globals[addr] = val; } // STORE_GLOBAL
    bcpl_push(bcpl_load_indirect(1)); // LOAD_INDIRECT
    ...
    // FUNCTION_HEADER - 4 parameters
    // UNKNOWN_83 83 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 78; } // BRANCH_IF_LT
    // UNKNOWN_48 48 - not implemented
    bcpl_push(bcpl_globals[2]); // LOAD_GLOBAL
    // LOOP_START L11
    // LOOP_END L10
    ...
    // UNKNOWN_78 78 - not implemented
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a != b) goto 86; } // BRANCH_IF_NEQ
    // LOCAL_VAR allocation
    // UNKNOWN_67 67 - not implemented
    // FUNCTION_END 3
    bcpl_push(168); // LOAD_CONSTANT
    ...
    // UNKNOWN_84 84 - not implemented
    // UNKNOWN_65 65 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 32; } // BRANCH_IF_EQ
    // LOCAL_VAR allocation
    // UNKNOWN_82 82 - not implemented
    // UNKNOWN_82 82 - not implemented
    // PUSH_STRING - string handling
    ...
    // UNKNOWN_32 32 - not implemented
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 80; } // BRANCH_IF_EQ
    // LOCAL_VAR allocation
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_84 84 - not implemented
    // LOCAL_VAR allocation
    ...
    // PUSH_STRING - string handling
    bcpl_pop(); // POP
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 95; } // BRANCH_IF_LT
    // UNKNOWN_2 2 - not implemented
    bcpl_push(135); // LOAD_CONSTANT
    bcpl_push(136); // LOAD_CONSTANT
    { bcpl_word_t addr = bcpl_pop(); bcpl_word_t val = bcpl_pop(); bcpl_globals[addr] = val; } // STORE_GLOBAL
    ...
    // UNKNOWN_65 65 - not implemented
    // UNKNOWN_78 78 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 32; } // BRANCH_IF_LT
    // UNKNOWN_67 67 - not implemented
    // UNKNOWN_65 65 - not implemented
    // UNKNOWN_83 83 - not implemented
    // LOCAL_VAR allocation
    ...
    // STRING_CONSTANT definition
    // UNKNOWN_84 84 - not implemented
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a < b) goto 80; } // BRANCH_IF_LT
    // LOCAL_VAR allocation
    // UNKNOWN_32 32 - not implemented
    // LOCAL_VAR allocation
    { bcpl_word_t b = bcpl_pop(); bcpl_word_t a = bcpl_pop(); if (a == b) goto 80; } // BRANCH_IF_EQ
    ...
    bcpl_pop(); // POP
    // STRING_CONSTANT definition
    if (bcpl_pop()) goto 100; // CONDITIONAL_JUMP
    L50:
    // LOOP_END L49
    // FUNCTION_END 3
    bcpl_push(bcpl_load_indirect(0)); // LOAD_INDIRECT
