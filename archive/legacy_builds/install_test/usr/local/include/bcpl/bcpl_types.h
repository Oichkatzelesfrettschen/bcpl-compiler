...
typedef struct bcpl_fcb {
  ...
  bcpl_word_t mode;                ///< File mode (read/write/append)
  bcpl_word_t pos;                 ///< Current position
  bcpl_word_t size;                ///< File size
  bcpl_char_t buffer[BCPL_BUFSIZ]; ///< I/O buffer
  bcpl_word_t bufpos;              ///< Buffer position
  bcpl_word_t bufend;              ///< Buffer end
  bcpl_bool_t dirty;               ///< Buffer needs writing
} bcpl_fcb_t;
...
typedef struct bcpl_context {
  ...
  bcpl_word_t global_size;    ///< Global vector size
  bcpl_word_t *stack_base;    ///< BCPL stack base
  bcpl_word_t *stack_end;     ///< BCPL stack end
  bcpl_word_t *stack_ptr;     ///< Current stack pointer
  ...
  bcpl_word_t argc;           ///< Command line argument count
  bcpl_string_t **argv;       ///< Command line arguments
  bcpl_string_t *param;       ///< Parameter string
