...
/**
 * @brief Read a character from specified stream
...
/**
 * @brief Write a character to specified stream
...
/**
 * @brief Check for stream failure/error
 * @param stream Stream to check
 * @return Non-zero if error, 0 if OK
 */
BCPL_EXPORT bcpl_word_t bcpl_findfail(bcpl_word_t stream);
