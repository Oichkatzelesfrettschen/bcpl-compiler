...
bcpl_word_t bcpl_string_length(const bcpl_word_t *str) {
  ...
  return (bcpl_word_t)(unsigned char)((const char *)str)[0];
}
...
bcpl_word_t bcpl_string_compare(const bcpl_word_t *str1,
  ...
  bcpl_word_t len1 = (bcpl_word_t)(unsigned char)s1[0];
  bcpl_word_t len2 = (bcpl_word_t)(unsigned char)s2[0];
...
void bcpl_string_copy(bcpl_word_t *dest, const bcpl_word_t *src) {
  ...
  bcpl_word_t len = (bcpl_word_t)(unsigned char)s[0];
